...
@section('content')
     <div class="container">
            ...
            if(!empty(Session::get("usertaskdata")))
            {
                ...
                $task = DB::select('select start_date,start_time from user_tasks where user_id='.$data[0]['userid'].' and task_id='.$data[0]['taskid']);               
                $start_date = $task[0]->start_date;
                $start_time = $task[0]->start_time;
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <tr>
                ...
                @elseif($val->status_admin == 'complete')
                    <td></td>
                    <td></td>
                    <td></td>
                @else

	...
	<div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="input-group input-group-sm" style="margin-top:5%;">
                ...
                <input class="form-control" id="from_date" name="from_date" type="text" value="{{ \Carbon\Carbon::parse($from_date)->format('d-m-Y') }}" placeholder="From Date">
            </div>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="input-group input-group-sm" style="margin-top:5%;">
                ...
                <input class="form-control" id="to_date" name="to_date" type="text" value="{{ \Carbon\Carbon::parse($to_date)->format('d-m-Y') }}" placeholder="To Date">
            </div>
        </div>
    ...
    <div class="row" style="margin-top:3%;">
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="input-group input-group-sm margin-top-10 pull-left">
                <button class="applyBtn btn btn-sm btn-primary" type="submit" id="apply_date_filter">Apply</button>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="input-group input-group-sm margin-top-10 pull-right">
                <button class="applyBtn btn btn-sm btn-primary" type="button" id="reset_date_filter">Reset</button>
            </div>
        </div>
    </div>
</div>